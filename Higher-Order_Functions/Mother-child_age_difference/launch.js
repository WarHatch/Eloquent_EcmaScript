/*
Using the example data set, compute the average age difference between mothers and children
...
// My code
var children = ancestry.filter( (person) => byName[person.mother] != null );
var ageDifferences = children.map( (child) => child.born - byName[child.mother].born );

console.log("The average age diff is: " + average(ageDifferences));