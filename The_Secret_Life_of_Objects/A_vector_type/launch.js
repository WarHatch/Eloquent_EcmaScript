...
var firstVec = new Vector(1,1);
var secondVec = new Vector(5,11);

console.log(firstVec);
console.log(secondVec);

var sum = firstVec.plus(secondVec);
console.log(sum);

var sub = firstVec.minus(secondVec);
console.log(sub);
...
console.log("Length of the second Vector: " + secondVec.length);
